...
### kNN
* kNN is good with small datasets with small number of features
...
How can we optimize parameters and improve?
experiment: try all n_neighbors from 1 to 10 and see which does best
